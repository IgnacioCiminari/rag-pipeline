...
from deepdoc.compat import get_project_base_directory, rag_tokenizer
...
class TableStructureRecognizer(Recognizer):
    ...
    def __init__(self):
        try:
            super().__init__(self.labels, "tsr", os.path.join(get_project_base_directory(), "deepdoc/res"))
        except Exception:
            super().__init__(
                self.labels,
                "tsr",
                snapshot_download(
                    ...
                    local_dir=os.path.join(get_project_base_directory(), "deepdoc/res"),
